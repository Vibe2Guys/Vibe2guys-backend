...
## `GET /api/v1/courses/{courseId}/home`

학생 강의 홈을 조회한다. 최근 공지, 할 일, 최근 학습, 주차 구성을 한 번에 내려준다.
...
강의 공지 목록을 조회한다. 학생/교수자 모두 접근 가능하다.
...
{
  "title": "3주차 프로젝트 안내",
  "body": "팀별 역할 분담안을 이번 주 금요일까지 제출해주세요.",
  "pinned": true
}
```
...
- `gradebook/me`는 출석, 진도, 과제, 퀴즈를 합산한 학생 개인 성적 요약을 반환한다.
